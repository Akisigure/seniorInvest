...
public interface QaDao {
	...
	@Select("select * from qaboard order by ref desc, re_step asc limit #{start}, #{count}")
	List<QaDto> selectList(Map<String, Object> m);
	...
	@Delete("delete from qaboard where no =#{no}")
